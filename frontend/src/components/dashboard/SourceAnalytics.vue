  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 select-none print:grid-cols-2 print:gap-4 print:text-charcoal-900">
      ...
      <div class="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar print:overflow-visible print:h-auto">
        ...
        >
          <div class="flex justify-between text-xs font-bold print:text-charcoal-950">
            <span class="text-charcoal-200 print:text-charcoal-800">{{ src.source_type }} ({{ src.total_projects }} Proj)</span>
            <span class="text-white print:text-charcoal-900">Confirmed: {{ formatMoney(src.confirmed_revenue) }}</span>
          </div>
          <div class="h-2 w-full bg-charcoal-900 rounded-full overflow-hidden print:bg-charcoal-100">
            <div 
    ...
    <div class="glass-panel p-6 bg-charcoal-800 border border-charcoal-700 rounded-2xl flex flex-col h-[350px] print:bg-white print:border print:border-charcoal-200 print:rounded-xl print:h-auto print:p-5">
      ...
      <div class="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar print:overflow-visible print:h-auto">
        ...
        >
          <div class="flex justify-between text-xs font-bold print:text-charcoal-950">
            <span class="text-charcoal-200 print:text-charcoal-800">{{ cust.customer_category }} ({{ cust.total_projects }} Proj)</span>
            <span class="text-white print:text-charcoal-900">Confirmed: {{ formatMoney(cust.confirmed_revenue) }}</span>
          </div>
          <div class="h-2 w-full bg-charcoal-900 rounded-full overflow-hidden print:bg-charcoal-100">
            <div 
    ...
    <div class="glass-panel p-6 bg-charcoal-800 border border-charcoal-700 rounded-2xl flex flex-col h-[350px] print:bg-white print:border print:border-charcoal-200 print:rounded-xl print:h-auto print:p-5">
      ...
      <div class="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar print:overflow-visible print:h-auto">
        ...
        >
          <div class="flex justify-between text-xs font-bold print:text-charcoal-950">
            <span class="text-charcoal-200 print:text-charcoal-800">{{ ev.event_category }} ({{ ev.total_projects }} Proj)</span>
            <span class="text-white print:text-charcoal-900">{{ formatMoney(ev.confirmed_revenue) }}</span>
          </div>
          <div class="h-2 w-full bg-charcoal-900 rounded-full overflow-hidden print:bg-charcoal-100">
            <div 
    ...
    <div class="glass-panel p-6 bg-charcoal-800 border border-charcoal-700 rounded-2xl flex flex-col h-[350px] print:bg-white print:border print:border-charcoal-200 print:rounded-xl print:h-auto print:p-5">
      ...
      <div class="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar print:overflow-visible print:h-auto">
        ...
        >
          <div class="flex justify-between text-xs font-bold print:text-charcoal-950">
            <span class="text-charcoal-200 print:text-charcoal-800">{{ prog.program_type }} ({{ prog.total_projects }} Proj)</span>
            <span class="text-white print:text-charcoal-900">{{ formatMoney(prog.confirmed_revenue) }}</span>
          </div>
          <div class="h-2 w-full bg-charcoal-900 rounded-full overflow-hidden print:bg-charcoal-100">
            <div 
