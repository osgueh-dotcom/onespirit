<template>
  <div class="glass-panel p-6 bg-charcoal-800 border border-charcoal-700 rounded-2xl flex flex-col select-none print:bg-white print:border print:border-charcoal-200 print:rounded-xl print:p-5 print:text-charcoal-900">
    <div class="flex items-center justify-between mb-4 border-b border-charcoal-700 pb-3 print:border-charcoal-200">
    ...
    <p class="text-xs text-charcoal-300 font-semibold leading-relaxed mb-4 print:text-charcoal-600">
    ...
    <div 
      v-if="!hasIssues" 
      class="py-12 flex flex-col items-center justify-center text-center gap-3 bg-charcoal-900/40 border border-charcoal-800 rounded-xl print:bg-charcoal-50 print:border-charcoal-200"
    >
    ...
    <div v-else class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 print:grid-cols-2">
      <!-- Missing PO -->
      <div 
        class="p-4 rounded-xl border flex flex-col bg-charcoal-900/40 print:bg-charcoal-50 print:border-charcoal-200"
