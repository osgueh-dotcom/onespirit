      ...
      <table class="w-full text-left text-xs font-bold border-collapse print:text-charcoal-900">
        ...
        <tbody>
          <tr v-if="data.length === 0">
            <td colspan="11" class="py-8 text-center text-muted-theme font-bold print:text-charcoal-400">
          ...
          >
            <td class="py-3.5 pl-2 text-main-theme print:text-charcoal-900">{{ pm.pm_name }}</td>
            <td class="py-3.5 text-center">
              <span class="px-2 py-0.5 bg-surface-theme border border-panel-theme rounded text-sky-400 print:bg-charcoal-50 print:border-charcoal-200 print:text-sky-700">
                {{ pm.initial_code || '-' }}
              </span>
            </td>
            <td class="py-3.5 text-center text-main-theme print:text-charcoal-900">{{ pm.total_projects }}</td>
