...
| **PO Control Center / Commercial Dashboard** | Implemented (Sprint 10) | **Ya** | Dashboard komersial harian/mingguan bagi PO untuk memantau status quotation, revenue (potential vs confirmed), deal/cancel rate, kontribusi lead source/partner, outstanding payment, serta daftar prioritas follow-up tindakan komersial dan risiko komersial. |
